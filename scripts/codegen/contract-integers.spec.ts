...
import { goPayload } from './go.ts'
import { javascript } from './javascript.ts'
import { type IntegerShape, shape } from './schema.ts'

const validationModule = pathToFileURL(
  path.join(packageRoot('core'), 'typescript', 'validation.ts')
).href
