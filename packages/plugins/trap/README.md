...
The Go module is `github.com/uni-kakurenbo/traq-markdown-engine/packages/plugins/trap/go`. Payloads and node factories are generated from this repository's Rust contracts by `bun run generate:bindings`. The canonical tree and Wasm runtime belong to the core Go module.
